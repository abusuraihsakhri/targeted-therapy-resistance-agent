"""
Automated Pytest for targeted-therapy-resistance-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    OverviewEngine,
    TumorHeterogeneityAnalysisFromMultiregionSamplingEngine,
    GoalEngine,
    DataModelChangesEngine,
    NewModuleEngine,
    AgentChangesEngine,
    PredictTreatmentEscapeRoutesEngine,
    ApiChangesEngine,
    TargetedtherapyresistanceagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = TargetedtherapyresistanceagentEnrichmentSuite()
