...
app = FastAPI(
    title="Targeted Therapy Resistance Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "targeted-therapy-resistance-agent", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
